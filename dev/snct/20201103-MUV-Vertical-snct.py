...
#----diretorio---#
raiz='C:/Users/breno/Documents/Drive - ifsp.edu.br/Estudo/PIC/SNCT 2020/repo/data20201104/'
...
#8ª coluna: tempo de simulação

tabela = [['Voleibol', 21.0, 270, 0, 0, 0, 0, 0, 0], ['Tênis de mesa', 3.8, 25, 0, 0, 0, 0, 0, 0], ['Futebol', 22.2, 454, 0, 0, 0, 0, 0, 0], ['Basquete', 24.3, 600, 0, 0, 0, 0, 0, 0]]
...
#8ª coluna: tempo de simulação
        ...
        tabela[i, 8] = float(t_p[len(t_p)-1])
        ...
        f16.set_ylabel('Energia normalizada ($E_{M}/E_{C_{0}}$)')
    ...
    f13.plot(t_t, v_t, 'k--', linewidth='0.8', dashes=(3,8), label='Ideal')
