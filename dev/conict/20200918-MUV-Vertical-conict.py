...
#----diretorio---#
raiz='C:/Users/breno/Documents/Drive - ifsp.edu.br/Estudo/PIC/11 CONICT/repo/datatest/'
...
for k in range(len(h_tabela)):
    for x in range(len(bolas_arr)):
        ...
        vterminal, altura = alturamin(massa_a, diametro_a, v_a, s_a, x)
...
for j in range(len(h)):
    for i in range(len(bolas_arr)):
        ...
        if h[j] == 10:
            f13.legend(loc='lower right')
            f14.legend(loc='lower left')
            f15.legend(loc='lower left')
            f16.legend(loc='lower left')
        ...
        if h[j] == 100:
            f13.legend(loc='upper left')
            f14.legend(loc='lower left')
            f15.legend(loc='upper right')
            f16.legend(loc='lower left')
